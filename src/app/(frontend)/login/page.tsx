          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="h-11 w-full rounded-lg border border-input bg-background pl-3 pr-10 text-sm outline-none transition duration-300 placeholder:text-muted-foreground hover:border-primary/40 focus-visible:border-primary/40 focus-visible:ring-2 focus-visible:ring-primary/40"
              />
              <button
                type="button"
